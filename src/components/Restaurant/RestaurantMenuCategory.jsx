...
const RestaurantMenuCategory = ({toggleCategoryVisibility,
                                    categoryVisibility,
                                    category,
                                    foodItems,
                                    handleDecrement,
  ...
  return (
      <div  className="mt-5 border-b-8 pb-4">
          <div className="flex items-center cursor-pointer" onClick={() => toggleCategoryVisibility(category)}>
            <span className="text-lg font-extrabold text-gray-500 mb-4">{category}</span>
          ...
          {categoryVisibility[category] && (
            <div>
              {Object.keys(foodItems[category]).map((itemName) => (
                <div key={itemName} className="flex justify-between items-center mb-2 border-b-2 py-4">
                  <div >
                    {
                    ...
                    <p className="text-md font-medium text-gray-700 mt-2">{itemName}</p>
                    <p className="text-gray-600 mt-2"><FaRupeeSign className='inline mb-1' /> {foodItems[category][itemName].price}</p>
                  </div>
                  {
